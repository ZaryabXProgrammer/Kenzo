...
const AllProductSlider = () => {
    ...
    return (
        <section className="pt-[4%] md:px-[6%] px-[1%]" id='collections'>
            ...
            <article className="flex flex-row items-center justify-between px-[4%]">
                ...
                <p className="text-xl font-bold">Mint Now!</p>
            </article>



            <div className="text-center p-10 ">
                <h1 className="font-bold text-4xl mb-4 pb-[4%]"><span className='text-red-700'>Collections</span> </h1>
