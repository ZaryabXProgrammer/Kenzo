...
const AllProductSlider = () => {
    ...
    return (
        <section className="pt-[4%] md:px-[6%] px-[1%] bg-gray-900" id='collections'>
            <article className="flex flex-row items-center justify-between px-[4%]">
                <h1 className="text-2xl font-semibold text-red-600">THEMES</h1>
                <p className="text-xl font-bold text-white">Mint Now!</p>
            </article>

            <div className="text-center p-10">
                <h1 className="font-bold text-4xl mb-4 pb-[4%] text-white">
                    <span className='text-red-700'>Collections</span>
                </h1>
                                    ...
                                    <a href="#">
                                        ...
                                        <div className="px-4 py-3 w-72">
                                            ...
                                            <div className="flex items-center">
                                                ...
                                                <del>
                                                    <p className="text-sm text-gray-500 cursor-auto ml-2">
                                                ...
                                                <div className="ml-auto">
                                                    <svg
                                                        ...
                                                        height="20"
                                                        fill="currentColor"
                                                        className="bi bi-bag-plus text-white"
                                                        viewBox="0 0 16 16"
                                                    >
                                                        <path
                                                            fillRule="evenodd"
