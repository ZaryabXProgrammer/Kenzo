...
const ProductCol = () => {
    return (
        <div className="flex flex-col md:flex-row bg-[#f1f1f1] mx-auto p-4 px-[5%] lg:px-[9%]">
            {/* Left side - Text content */}
            <div className="md:w-1/2 p-4 md:p-8">
                <div className="border border-pink-200 p-6 rounded-lg">
                    <h2 className="text-xl md:text-2xl font-bold text-black mb-4">Ethereal Dreams NFT Collection</h2>
                    <p className="text-gray-600 mb-4 text-sm md:text-base">Unlock exclusive digital art: +83% rarity guarantee (1) unique blockchain authentication (2)</p>
                    <p className="text-gray-600 mb-4 text-sm md:text-base">100% verified ownership: secure and transparent transactions.</p>
                    <p className="text-gray-600 mb-4 text-sm md:text-base">94% collectors report increased portfolio value. (3)</p>

                    <h3 className="font-semibold text-black mt-6 mb-2 text-sm md:text-base">Collector Benefits:</h3>
                    ...
                    <p className="text-gray-600 mt-6 text-xs md:text-sm">These benefits are based on industry trends and collector experiences. (5)</p>
