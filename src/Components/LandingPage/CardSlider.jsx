...
const CardSlider = () => {
    ...
    return (
        <section className="pt-[4%] px-[6%] bg-gray-900 text-white" id='nftMarketplace'>

            <article className="flex flex-row items-center justify-between px-[4%]">
                <h1 className="text-2xl font-semibold text-red-500">NFT</h1>
                    ...
                    <div ref={sliderRef} className="keen-slider">
                        {products.map((product) => (
                            <div key={product.id} className="keen-slider__slide">
                                <div className="w-72 bg-gray-800 shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl mx-auto">
                                    <a href="#">
                                        ...
                                        <div className="px-4 py-3 w-72">
                                            ...
                                            <p className="text-lg font-bold text-white truncate block capitalize">{product.name}</p>
                                            <div className="flex items-center">
                                                <p className="text-lg font-semibold text-white cursor-auto my-3">{product.price}</p>
                                                <del>
                                                    <p className="text-sm text-gray-500 cursor-auto ml-2">{product.originalPrice}</p>
                                                </del>
                                                <div className="ml-auto">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-bag-plus text-white" viewBox="0 0 16 16">
